...
void RenderEngine::Render(){
	...
	//The Camera Matrices are now defined in the camera class
	...
	XMStoreFloat4x4(&WorldMatrix1.View, XMMatrixTranspose(mainCamera.getCamView()));
	XMStoreFloat4x4(&WorldMatrix1.Projection, XMMatrixTranspose(mainCamera.getCamProjection()));
