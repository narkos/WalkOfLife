...
public:
	Platform(bool isDeadly, vector<XMFLOAT3> verts, ID3D11Buffer *b, XMFLOAT3 pos, bool isActive, bool isStatic, BoundingOrientedBox bbox) : CollisionObject(b, pos, isActive, isStatic, bbox){ //och eventuellt ha med tex isBouncy
