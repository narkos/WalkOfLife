...
public:
	CollectableObject(int coinValue, int timeValue, ID3D11Buffer *b, XMFLOAT3 pos, bool isActive, bool isStatic, BoundingOrientedBox bbox) : CollisionObject(b, pos, isActive, isStatic, bbox){
